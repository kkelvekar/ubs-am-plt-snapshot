    ...
    bool ShowHelp = false)
{
    ...
    public static string HelpText =>
        ...
        Usage:
          dotnet run --project tools/UBS.AM.PLT.SnapshotWriter.TestProducer -- [bootstrapServers] [options]
        ...
        Quick local smoke test:
          dotnet run --project tools/UBS.AM.PLT.SnapshotWriter.TestProducer -- --snapshots 1 --message-delay 00:00:00
        """;
