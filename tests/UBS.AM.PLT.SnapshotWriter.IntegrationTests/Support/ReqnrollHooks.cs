...
/// <see cref="SnapshotWriterFixture"/> (real production object graph against real Azure
...
public sealed class ReqnrollHooks
{
    ...
    private static SnapshotWriterFixture? _fixture;
    ...
    private static SnapshotWriterFixture Fixture =>
        _fixture ?? throw new InvalidOperationException("SnapshotWriterFixture has not been initialised for this test run.");

    [BeforeTestRun]
    public static async Task BeforeTestRunAsync()
    {
        _fixture = new SnapshotWriterFixture();
