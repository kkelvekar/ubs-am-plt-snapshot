...
/// inside the "failure-scenario snapshot" step. The run-scoped <see cref="SnapshotWriterFixture"/>
...
public sealed class RedeliveryAfterOffsetCommitFailureSteps
{
    ...
    public RedeliveryAfterOffsetCommitFailureSteps(SnapshotWriterFixture fixture, ScenarioFixtureContext scenario)
    {
        _fixture = fixture;
        _scenario = scenario;
    }
