...
/// snapshot" step. The run-scoped <see cref="SnapshotWriterFixture"/> and scenario-scoped
...
public sealed class RedeliveryIdempotencySteps
{
    ...
    public RedeliveryIdempotencySteps(SnapshotWriterFixture fixture, ScenarioFixtureContext scenario)
    {
        _fixture = fixture;
        _scenario = scenario;
    }
