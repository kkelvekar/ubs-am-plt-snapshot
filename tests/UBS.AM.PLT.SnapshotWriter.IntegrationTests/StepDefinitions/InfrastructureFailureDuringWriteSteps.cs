...
/// run-scoped <see cref="SnapshotWriterFixture"/> and scenario-scoped
...
public sealed class InfrastructureFailureDuringWriteSteps
{
    ...
    public InfrastructureFailureDuringWriteSteps(SnapshotWriterFixture fixture, ScenarioFixtureContext scenario)
    {
        _fixture = fixture;
        _scenario = scenario;
    }
