...
/// exceptions become a 400 carrying the safe reason; everything else becomes a 500 that leaks
/// no exception detail or stack trace and is logged at Error. The written JSON body is
/// inspected directly so a regression that surfaces internals would fail the test.
/// </summary>
